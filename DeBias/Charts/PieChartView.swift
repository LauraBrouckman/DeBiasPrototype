...
public class PieChartView: PieRadarChartViewBase
{
    ...
    public var centerText: String?
    {
        ...
        set
        {
            ...
            {
                let arr = newValue!.componentsSeparatedByString(" ")
                ...
                if arr.count == 1  {
                    ...
                    attrString?.setAttributes([
                        ...
                        NSFontAttributeName: NSUIFont.systemFontOfSize(15.0),
                    ...
                    numberLabel.frame = CGRectMake(bounds.minX, bounds.minY, bounds.maxX, bounds.maxY)
                    numberLabel.center = CGPointMake(bounds.midX - 108, bounds.midY - 10)
                    numberLabel.textAlignment = NSTextAlignment.Center
                    numberLabel.font = UIFont(name: "Helvetica", size: CGFloat(50.0))
                    numberLabel.textColor = UIColor(red: 0.35, green: 0.35, blue: 0.35, alpha: 1)
                    ...
                    attrString?.setAttributes([
                        NSForegroundColorAttributeName: NSUIColor.blackColor(),
                        NSFontAttributeName: NSUIFont.systemFontOfSize(25.0),
                        NSParagraphStyleAttributeName: paragraphStyle
                        ], range: NSMakeRange(0, attrString!.length))
                }
            }
