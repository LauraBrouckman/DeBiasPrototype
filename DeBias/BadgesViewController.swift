...
class BadgesViewController: UICollectionViewController{
    ...
    func initBadges()
    {
        let badge1 = Badge(title: "Read 5 Conservative Articles", completed: true, backgroundCircle: UIImage(named: "red-circle.png")!)!
        ...
        let badge7 = Badge(title: "#1 in Articles Read Ranking", completed: true, backgroundCircle: UIImage(named: "purple-circle.png")!)!
        ...
        badges += [badge3, badge1, badge2, badge7, badge4, badge5, badge6, badge8]
    }
